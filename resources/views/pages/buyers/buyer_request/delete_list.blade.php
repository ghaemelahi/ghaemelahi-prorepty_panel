@extends('layouts.app')
@section('title', 'درخواست خرید')
@section('content')

    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
                <h4 class="fw-bold fs-18 mb-0">درخواست خرید‌های حذف شده</h4>
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('buyer_request_undelete') }}" method="post">
                                                ...
                                                <input type="hidden" name="buyer_name" value="{{ $item->name }}">
                                                <button type="submit"
                            ...
                            @else
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">درخواست خرید یافت نشد.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>

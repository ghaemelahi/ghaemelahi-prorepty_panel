@extends('layouts.app')
@section('title', 'آرشیوها')
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">آرشیوها</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">آرشیوها</span>
            </li>
        </ul>
    </div>
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            {{-- <div class="d-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
                <h4 class="fw-semibold fs-18 mb-0">آرشیوها</h4>
                                ...
                                @foreach ($data['archives'] as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <button
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#descritionModal{{ $item->id }}">
                                    ...
                                    <div class="modal fade" id="ImageRequestModal{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ImageRequestModalLabel{{ $item->id }}">
                                                        عکس‌ها
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="بستن"></button>
    ...
    {{-- <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body p-4">
            <form action="{{ route('seller_request_store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group mb-4">
                    <label class="label">نام فروشنده *</label>
                    <input type="text" name="seller_name" readonly value="{{ $item->seller_name }}"
                        class="form-control text-dark" placeholder="نام فروشنده">
                </div>
                <div class="form-group mb-4">
                    <label class="label">شماره تماس فروشنده *</label>
                    <input type="text" name="seller_phone" readonly value="{{ $item->seller_phone }}"

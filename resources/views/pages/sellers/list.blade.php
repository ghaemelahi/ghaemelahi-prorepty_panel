...
@section('content')
    ...
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">فروشندگان</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">فروشندگان</span>
            </li>
        </ul>
    </div>
    ...
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
                <h4 class="fw-semibold fs-18 mb-sm-0">لیست فروشندگان</h4>
                        ...
                        <div class="modal-content">
                            <form action="{{ route('seller_store') }}" method="POST">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addUserModalLabel">افزودن فروشنده جدید</h5>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary text-white">ثبت فروشنده</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex gap-3 justify-content-center mb-4 pb-1">
                                                ...
                                                <a href="{{ route('seller_requests', $item->id) }}"
                                            ...
                                            <div class="modal fade" id="deleteUserModal{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            آیا مطمئن هستید که می‌خواهید فروشنده "{{ $item->name }}" را
                                                            حذف
                                                            کنید؟
                                                        </div>
                                                        <div class="modal-footer">

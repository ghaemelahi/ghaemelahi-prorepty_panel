                            ...
                            <div class="modal-content">
                                <form method="GET">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 text-start col-md-6">
                                                ...
                                                <input type="text"
                                                    value="{{ $request_monthly_amount != null ? number_format($request_monthly_amount) : '' }}"
                                                    onkeyup="separate(this);" class="form-control" id="request_monthly_amount"
                                                    name="request_monthly_amount">
                                            </div>
                                            <div class="mb-3 text-start col-md-6">
                                                <label class="form-label d-block mb-2">پیش‌ پرداخت</label>
                                                <input type="text"
                                                    value="{{ $request_down_payment != null ? number_format($request_down_payment) : '' }}"
                                                    onkeyup="separate(this);" class="form-control" id="request_down_payment"
                                                    name="request_down_payment">
                                            </div>
                                            <div class="mb-3 text-start col-md-6">
                                    ...
                                    <div class="modal-footer">
                                        <a href="{{ route('rent_list_sells_requests') }}"

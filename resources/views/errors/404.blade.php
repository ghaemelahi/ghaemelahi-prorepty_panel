...
<head>
    ...
    <title>خطا ۴۰۴ — صفحه یافت نشد</title>
        ...
        <div class="card-centered text-center">
            <div class="error-badge">
                <div class="error-circle">
                    <div class="error-num">۴۰۴</div>
                </div>
                <div>
                    <div class="error-title">صفحه یافت نشد</div>
                    <div class="subtext">صفحه مورد نظر شما وجود ندارد</div>
                </div>
            </div>
            ...
            <div class="small-note">
                ممکن است آدرس صفحه تغییر کرده باشد یا صفحه حذف شده باشد. لطفاً آدرس را بررسی کنید یا به صفحه اصلی بازگردید.
            </div>

            <div class="action-buttons">
                <a href="{{ url('/') }}" class="btn btn-primary">بازگشت به صفحه اصلی</a>
                <button onclick="window.history.back()" class="btn btn-outline-primary">بازگشت به صفحه قبل</button>
            </div>
        </div>
    </div>
</body>

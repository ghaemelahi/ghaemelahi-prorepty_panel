...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        /* با اسلش جلو یکسان می‌کنیم تا روی ویندوز کلید آرایهٔ فونت‌ها یکسان باشد و خطای Undefined array key برطرف شود */
        'font_dir' => str_replace('\\', '/', storage_path('fonts')),
         ...
         * Note: This directory must exist and be writable by the webserver process.
         */
        'font_cache' => str_replace('\\', '/', storage_path('fonts')),
